...
public class CourseController {
	...
	public ModelAndView viewCourse(@RequestParam("courseId") Integer courseId,
			Model model) {
		...
		mv.setViewName("course_overview");
		return mv;
	}
	...
	public  ModelAndView test11(HttpServletRequest request){
		System.out.println(request.getParameter("name"));
		ModelAndView mv = new ModelAndView();
		mv.setViewName("test1");
		mv.addObject("msg","hhhhhhhhhh");
		return mv;
	}
